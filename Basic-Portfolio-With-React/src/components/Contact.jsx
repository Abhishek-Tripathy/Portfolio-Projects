...
function Contact() {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      emailjs
        ...
        .then((response) => {
          ...
          setFormData({ name: "", email: "", messaage: "" });
        })
        .catch((error) => {
  ...
  return (
    <div className="p-4 lg:w-3/4" id="contact">
      ...
      <motion.form initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8, delay: 0.7}}
      onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
            ...
            rows="6"/>
               {errors.message && (
                  <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}}
                  className="text-sm text-rose-800">{errors.messaage}</motion.p>
               )}
          </div>
